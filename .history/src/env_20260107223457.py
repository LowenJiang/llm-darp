...
A clean, standalone implementation without deep inheritance hierarchies.
Uses nn.Module as base with TensorDict for state management.
"""
...
class PDPTWEnv(nn.Module):
    ...
    - Level 1: Immediate reachability (can reach within time window)
    - Level 2: One-step lookahead (visiting node doesn't make obligations impossible)
    """
