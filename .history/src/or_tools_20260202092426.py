...
def routes_to_actions(routes: List[List[int]]) -> List[int]:
    ...
    if not actions:
        actions = [0]  # trivial route: start/end at depot
    return actions
...
def darp_solver(
    ...
    2. Optimization objective is minimizing total travel time + 250 * vehicles used.
    ...
    Returns:
        Dictionary containing:
            ...
            - total_cost: Total travel time + 250 * vehicles_used.
            ...
            - actions_tensor: Torch tensor version of actions (dtype long).
    """
    ...
    routing.SetFixedCostOfAllVehicles(int(250 * TIME_SCALE))
...
@
    ...
    total_cost = total_distance + 250 * vehicles_used
