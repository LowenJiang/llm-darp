...
class DVRPEnv(gym.Env):
    ...
    def __init__(
        ...
        Args:
            ...
            force_accept: If True, all proposed shifts are accepted and patience penalty is disabled.
    ...
    def step(
        ...
        if self.force_accept:
            accepted_mask = torch.ones(self.batch_size, dtype=torch.bool, device=self.device)
            final_p_shifts = pickup_shifts
            final_d_shifts = dropoff_shifts
