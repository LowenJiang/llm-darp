...
class SFGenerator(Generator):
    ...
    def _generate(self, batch_size) -> TensorDict:
        ...
        if self.shuffle_pairs and self.num_customers > 1:
            h3_indices, time_windows, demand, locs = self._shuffle_pairs(h3_indices, time_windows, demand, locs)
    ...
    def _load_trips(self) -> Dict[int, List[Dict[str, Tuple[int, int] | H3Index]]]:
        ...
        required_columns = {"traveler_id", "origin_h3", "destination_h3", "departure_time_window", "arrival_time_window"}
    ...
    def _shuffle_pairs(
        ...
        return randomized_h3_indices, randomized_time_windows, randomized_demand, randomized_locs
